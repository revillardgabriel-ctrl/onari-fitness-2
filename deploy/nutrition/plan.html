...
<title>Nutrition - Plan hebdomadaire</title>
...
<header class="flex justify-between items-center px-6 h-16 w-full fixed top-0 z-50 bg-[#0e0e0e]/80 backdrop-blur-lg shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
  <div class="flex items-center gap-4">
    ...
    <h1 class="font-headline font-bold text-lg tracking-wide uppercase text-[#69f6b8]">Nutrition</h1>
  </div>
  <div class="w-10 h-10 rounded-full overflow-hidden border border-outline-variant/30 active:scale-95 transition-transform cursor-pointer">
    <img alt="Profil" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBFJi25J8IdR-8LJ7HTnkaNWY05CvWrUh4SNeN1aRUJ-BosQmeQrqTMYWFVqmaPRgYfDc1EzUyqjp89BLruKJmDNwnWg3PVjwfq6CKx1meYf6iXTufbBE2qAqEQbj7XZaXTdf4e4hGoPaWimH0ta0RJHxWP8HQOzh25KJP_rS4Px3KnbvoXrnlkfk0vCPtqKklBndEPwS9MWUhyoqU7LTG1Hvb1IKSF1gHyzzq8p-GjZYT5R4QeB2T-WO4AOnI78NX47FXEnjJdD4Xm"/>
  </div>
</header>
...
<main class="pt-24 pb-32 px-6 max-w-5xl mx-auto min-h-screen">
  ...
  <section class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
    <div>
      <h2 class="font-headline text-3xl font-extrabold tracking-tight mb-2">Plan Hebdomadaire</h2>
      <p class="text-on-surface-variant text-sm font-medium">Optimisez vos apports avec une précision chirurgicale.</p>
    </div>
  ...
  <section class="mb-10 -mx-6 px-6 overflow-x-auto hide-scrollbar flex gap-4 scroll-smooth">
    <div class="flex flex-col items-center justify-center min-w-[72px] h-24 rounded-2xl bg-surface-container-low text-zinc-500 cursor-pointer hover:bg-surface-container-high transition-colors">
      <span class="text-[10px] font-bold uppercase tracking-widest mb-1">Lun</span>
      <span class="font-headline text-xl font-bold">12</span>
    </div>
    <div class="flex flex-col items-center justify-center min-w-[72px] h-24 rounded-2xl bg-surface-container-low text-zinc-500 cursor-pointer hover:bg-surface-container-high transition-colors">
      <span class="text-[10px] font-bold uppercase tracking-widest mb-1">Mar</span>
    ...
    <div class="flex flex-col items-center justify-center min-w-[72px] h-24 rounded-2xl bg-primary text-on-primary-container cursor-pointer shadow-[0_15px_30px_rgba(105,246,184,0.2)]">
      <span class="text-[10px] font-bold uppercase tracking-widest mb-1">Mer</span>
      <span class="font-headline text-xl font-bold">14</span>
      <div class="w-1.5 h-1.5 rounded-full bg-on-primary-container mt-1"></div>
    </div>
    <div class="flex flex-col items-center justify-center min-w-[72px] h-24 rounded-2xl bg-surface-container-low text-zinc-500 cursor-pointer hover:bg-surface-container-high transition-colors">
      <span class="text-[10px] font-bold uppercase tracking-widest mb-1">Jeu</span>
      <span class="font-headline text-xl font-bold">15</span>
    </div>
    <div class="flex flex-col items-center justify-center min-w-[72px] h-24 rounded-2xl bg-surface-container-low text-zinc-500 cursor-pointer hover:bg-surface-container-high transition-colors">
      <span class="text-[10px] font-bold uppercase tracking-widest mb-1">Ven</span>
      <span class="font-headline text-xl font-bold">16</span>
    </div>
    <div class="flex flex-col items-center justify-center min-w-[72px] h-24 rounded-2xl bg-surface-container-low text-zinc-500 cursor-pointer hover:bg-surface-container-high transition-colors">
      <span class="text-[10px] font-bold uppercase tracking-widest mb-1">Sam</span>
      <span class="font-headline text-xl font-bold">17</span>
    </div>
    <div class="flex flex-col items-center justify-center min-w-[72px] h-24 rounded-2xl bg-surface-container-low text-zinc-500 cursor-pointer hover:bg-surface-container-high transition-colors">
      <span class="text-[10px] font-bold uppercase tracking-widest mb-1">Dim</span>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
    ...
    <!-- Petit-déjeuner (rempli) -->
    <div class="glass-card rounded-xl overflow-hidden group border border-outline-variant/5">
      <div class="relative h-40 w-full overflow-hidden">
        <img alt="Petit-déjeuner" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC_Q4u4Y0pGf9tA3RHS0W5Ar9mVkZiIoHAwxNYMz_I8tc93uNZVazSif5LeLSh-0STgfddUXHaRJOmltHnUDGzvVn7X4O8OvXtboSs0f7sOmBATbwNBoO58YkdSLyKoAnaqae20zt44x0nHScCZMcuWhYpYjSpmLtOHA61iOBkAjvGaEIXU_y_tbfgW6scg_1ty03gFlzVllDQXJEVT7VZApMTYgPDG9hOlJmw-7xynU_zBhfms1WZrb64Ahj28IDpUolgM_5JXxIrf"/>
        <div class="absolute inset-0 bg-gradient-to-t from-surface-container-low to-transparent"></div>
        <div class="absolute bottom-4 left-6">
          <span class="bg-primary/20 backdrop-blur-md text-primary px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-tighter mb-1 inline-block">Petit-déjeuner</span>
          <h3 class="font-headline text-xl font-bold text-white">Bowl Énergie Verte</h3>
        </div>
      </div>
      <div class="p-6 flex justify-between items-center">
        <div class="flex items-center gap-4">
          <div>
            <p class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">Énergie</p>
            <p class="font-headline font-bold text-primary">420 KCAL</p>
          </div>
          <div class="w-px h-8 bg-outline-variant/20"></div>
          <div>
            <p class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest">Protéines</p>
    ...
    <div class="glass-card rounded-xl overflow-hidden group border border-outline-variant/5">
      <div class="relative h-40 w-full overflow-hidden">
        <img alt="Déjeuner" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCHmha_UMLAP0msP0DIYJ6ZTU4bEa7AowwfvX9AJC9dpjF-GSg03JWAljETA2Ev2UIiMRE4_UOsNbGWITjb0ozSy36VbAlJFed7CImDnwVFMKhgcVUZ2sGNHBBLu8_jEznZTHTmq2-P7jPzl9PX3NXpkV-OvX-6IMZFGvVOSbDnIbB6lh2S7cxI-s5CvZpuENH5roqWZL9cL-2tWIEVwq5JP6ln_Ni9YRi1_myznklp3QjcxulJNRaN9psfyMzBP377234umY5c1DJ-"/>
        <div class="absolute inset-0 bg-gradient-to-t from-surface-container-low to-transparent"></div>
        <div class="absolute bottom-4 left-6">
          <span class="bg-primary/20 backdrop-blur-md text-primary px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-tighter mb-1 inline-block">Déjeuner</span>
          <h3 class="font-headline text-xl font-bold text-white">Assiette Macro Saumon</h3>
        </div>
      </div>
      <div class="p-6 flex justify-between items-center">
        <div class="flex items-center gap-4">
    ...
    <div class="bg-surface-container-low rounded-xl p-6 border-2 border-dashed border-outline-variant/20 flex flex-col items-center justify-center min-h-[160px] group hover:border-primary/40 transition-colors cursor-pointer">
      ...
      <p class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest mb-1">Dîner</p>
      <p class="text-sm font-semibold text-zinc-500">Ajouter un repas au plan</p>
    </div>
    ...
    <div class="bg-surface-container-low rounded-xl p-6 border-2 border-dashed border-outline-variant/20 flex flex-col items-center justify-center min-h-[160px] group hover:border-primary/40 transition-colors cursor-pointer">
      ...
      <p class="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest mb-1">Collation</p>
      <p class="text-sm font-semibold text-zinc-500">Ajouter un repas au plan</p>
    </div>
  </div>
  ...
  <section class="mb-12">
    <div class="bg-surface-container-low rounded-xl p-8 border border-outline-variant/10 shadow-2xl relative overflow-hidden">
      ...
      <h4 class="text-[11px] font-black text-primary uppercase tracking-[0.2em] mb-8">Résumé journalier</h4>
      <div class="flex flex-col lg:flex-row gap-12 lg:items-center">
        <!-- Métrique principale -->
        <div class="flex flex-col">
          <span class="text-on-surface-variant text-[10px] font-bold uppercase tracking-widest mb-1">Apport planifié</span>
          ...
          <div class="mt-4 flex items-center gap-2">
            ...
            <span class="text-[10px] font-bold text-zinc-500">48 % sur 2 200</span>
          </div>
        </div>
        ...
        <div class="flex-1 grid grid-cols-3 gap-6">
          <div class="space-y-1">
            <div class="flex justify-between items-end">
              <span class="text-[10px] font-bold text-blue-400 uppercase">Protéines</span>
          ...
          <div class="space-y-1">
            <div class="flex justify-between items-end">
              <span class="text-[10px] font-bold text-red-400 uppercase">Glucides</span>
          ...
          <div class="space-y-1">
            <div class="flex justify-between items-end">
              <span class="text-[10px] font-bold text-[#69f6b8] uppercase">Lipides</span>
              <span class="font-headline text-sm font-bold">38g</span>
            </div>
            <div class="h-1 bg-surface-container rounded-full overflow-hidden">
              <div class="h-full bg-[#69f6b8] rounded-full" style="width: 38%;"></div>
            </div>
          </div>
        </div>
      </div>
...
<nav class="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 pb-6 pt-3 bg-[#131313]/90 backdrop-blur-2xl rounded-t-[28px] shadow-[0_-20px_40px_rgba(0,0,0,0.4),0_0_10px_rgba(105,246,184,0.05)]">
  ...
  <div class="flex flex-col items-center justify-center text-[#69f6b8] bg-[#69f6b8]/10 rounded-[20px] px-4 py-2 active:scale-90 transition-all duration-300 ease-out cursor-pointer">
    <span class="material-symbols-outlined mb-1" style="font-variation-settings: 'FILL' 1;" data-icon="calendar_month">calendar_month</span>
