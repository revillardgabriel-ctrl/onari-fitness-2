...
<span class="font-manrope text-[10px] font-semibold uppercase tracking-widest text-zinc-500 hover:opacity-80 transition-all cursor-pointer">Journal</span>
<span class="font-manrope text-[10px] font-semibold uppercase tracking-widest text-zinc-500 hover:opacity-80 transition-all cursor-pointer">Dashboard</span>
<span class="font-manrope text-[10px] font-semibold uppercase tracking-widest text-[#69f6b8] hover:opacity-80 transition-all cursor-pointer">Recipes</span>
<span class="font-manrope text-[10px] font-semibold uppercase tracking-widest text-zinc-500 hover:opacity-80 transition-all cursor-pointer">Plan</span>
</div>
